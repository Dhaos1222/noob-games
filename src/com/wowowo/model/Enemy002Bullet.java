...
public class Enemy002Bullet extends EnemyBullet{
	
	public Enemy002Bullet(MyPanel myPanel)
	{
		super(myPanel);
		this.width = 10;
		this.height = 10;
		...
		this.images=new Image[] {
				Toolkit.getDefaultToolkit().getImage(Enemy002Bullet.class.getResource("/Image/enemybullet.png"))
